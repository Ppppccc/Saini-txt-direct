...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/DARKPRINCE7078_BOT")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="📞 Contact", url="https://t.me/DARKPRINCE7078_BOT"),
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/All_Coching_Paid_Course"),
        ],
    ]
)
...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        ...
        f"**If you have any questions, feel free to ask [*DARK* *PRINCE*🐦](https://t.me/All_Coching_Paid_Course)! 💬**\n"
        )
    ) 
...
async def txt_handler(bot: Client, m: Message):
    ...
    if raw_text3 == '1':
        CR = '[DARK PRINCE 🐦](https://t.me/All_Coching_Paid_Course)'
    else:
        CR = raw_text3
            ...
            try:
                ...
                if "drive" in url:
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [*DARK* *PRINCE*🐦](https://t.me/All_Coching_Paid_Course)"
